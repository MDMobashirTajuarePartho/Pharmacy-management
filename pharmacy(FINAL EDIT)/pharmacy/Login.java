...
public class Login extends JFrame implements ActionListener{
  ...
  public Login() {
    ...
    this.setTitle(" Login :  Aiub Pharmacy Management System");
  ...
  private void initializeComponents() {
    ...
    this.headline=new JLabel("Aiub Pharmacy Management System");
    this.headline.setBounds(300, 10, 500, 100);
    headline.setFont(fff);
    headline.setForeground(Color.black);
    this.panel.add(this.headline);
    
    this.infoadd=new JLabel("******Login*****");
    this.infoadd.setBounds(600, 150, 500, 100);
   infoadd.setFont(f);
    ...
    button = new JButton("log-in");
     button.setBounds(530, 370, 100, 30);
     button.setFont(ff);
    ...
    button2.setBounds(560, 420, 200, 30);
     button2.setFont(ff);
